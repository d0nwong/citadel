...
## [AP-279](https://trello.com/c/YOhKyqkF) [FE] Studio page
...
## [AP-278](https://trello.com/c/Ep2oYTY2) [FE] Clients admin
...
## [AP-285](https://trello.com/c/zFXt4R6D) [FE] Admin Entities
...
## [AP-280](https://trello.com/c/ulZEMFGQ) [FE] Team and group pages
...
## [AP-283](https://trello.com/c/rMNnBmyL) [FE] Users admin
...
## [AP-281](https://trello.com/c/OzzMwvrJ) [FE] Project About tab editor
...
## [AP-282](https://trello.com/c/06OKTYjD) [FE] Department questionnaire editor

- **No bulk reorder endpoint.** [S 201–203](25-sep.md#L201-L203) (PLANNED). Also [U 728–729](Updated.md#L728-L729).

## [AP-284](https://trello.com/c/TnanKrp6) [FE] Asset types and size multipliers
...
1. When a studio or team leader is removed, does their userType drop back to internal? Blocks [AP-279](https://trello.com/c/YOhKyqkF) and [AP-280](https://trello.com/c/ulZEMFGQ).
2. Teams writes: team lead+? Blocks [AP-280](https://trello.com/c/ulZEMFGQ).
3. Size multiplier writes: team lead+? Blocks [AP-284](https://trello.com/c/TnanKrp6).
4. User creation and role assignment: admin+ or studio lead+? Blocks [AP-283](https://trello.com/c/rMNnBmyL).
5. workCapacity: keep open or lock down? Blocks [AP-283](https://trello.com/c/rMNnBmyL).
6. Project notes: create only, or also edit and delete? Blocks [AP-281](https://trello.com/c/OzzMwvrJ).
