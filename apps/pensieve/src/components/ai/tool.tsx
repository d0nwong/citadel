...
export function Tool({
  ...
  return (
    <Collapsible
      className={cn(
        "overflow-hidden rounded-lg border border-border bg-card/70",
        className
      )}
      {...props}
    />
...
export function ToolContent({
  ...
  return (
    <CollapsibleContent
      className={cn(
        "space-y-2 border-border border-t px-3 py-2 text-sm",
        className
      )}
      {...props}
    />
...
export function ToolInput({
  ...
  return (
    <pre
      className={cn(
        "overflow-x-auto rounded-md bg-secondary p-2 font-mono text-xs",
        className
      )}
    >
