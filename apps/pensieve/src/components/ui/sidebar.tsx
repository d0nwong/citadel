...
/**
 * shadcn/ui Sidebar, vendored by `shadcn add sidebar` and adapted to this repo's lint rules:
 * named React imports, no cookie (the open state is not read back on the server), and
 * the keyboard shortcut kept. The docs tree in it is built by components/app-shell.tsx.
 */
